...
public class DenizenTriggerSoldTrigger extends AbstractDenizenTraderTrigger implements Listener {
	...
	@Override
	public boolean parse(DenizenNPC arg0, Player arg1, String arg2) {
		// TODO Auto-generated method stub
		return false;
	}
...
//
//		if (plugin.debugMode) cs.sendMessage(ChatColor.LIGHT_PURPLE + "+- Parsing transaction trigger: " + theDenizen.getName() + "/" + thePlayer.getName() + " -+");
