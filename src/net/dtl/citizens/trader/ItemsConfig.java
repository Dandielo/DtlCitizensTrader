...
public class ItemsConfig {	
	...
	public ItemsConfig(ConfigurationSection config) {
		...
		manageWand = convertStringData(config.getString("manage","280"));
		settingsWand = convertStringData(config.getString("settings","340"));
	...
	public void reloadConfig()
	{
		...
		this.manageWand = convertStringData(traderSection.getString("manager-mode-toggle","280"));
